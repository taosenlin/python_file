...
# 14、字典get()方法
# python字典get()方法和setdefault()方法类似，返回指定键的值，如果键不在字典中，返回一个指定值，默认为None
# get()和setdefault()区别：setfault()返回的键如果不在字典中，会添加键(更新字典)，而get()不会添加键

# get()方法语法:
# D.get(key[,default=None])
# key--字典中要查找的键
# default--可选参数，如果指定键的值不存在时，返回该值，默认为None

'''
D = {'name':'tt','age':18}
print("age值为:%s" % D.get('age'))
print("sex值为:%s" % D.get('sex','NA'))
print("sex值为:%s" % D.get('sex'))
# age值为:18
# sex值为:NA
# sex值为:None
'''
