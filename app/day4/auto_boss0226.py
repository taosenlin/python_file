...
#输入旧密码
driver.find_element_by_id('com.hpbr.bosszhipin:id/et_old').send_keys('boss123')

#新密码
driver.find_element_by_id('com.hpbr.bosszhipin:id/et_new').send_keys('boss666')

#确认密码
driver.find_element_by_id('com.hpbr.bosszhipin:id/et_new_confirm').send_keys('boss666')
